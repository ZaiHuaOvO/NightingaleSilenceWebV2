...
import { normalizeNSPlateUiAssetPath, resolveNSPlateImageUrl } from '@/lib/plate/assetUrls'
import {
...
import { resolveNSPlateInfoTextAdaptiveColor } from '@/lib/plate/infoTextAdaptiveColor'
import {
  NSPLATE_INFO_ACTIVITY_ICON_CATEGORY,
  NSPLATE_INFO_ACTIVITY_ICON_SIZE_PX,
  NSPLATE_INFO_BAR48_BASE_CELL_WIDTH_PX,
  NSPLATE_INFO_BAR48_CENTER_GAP_BASE_PX,
  NSPLATE_INFO_BAR48_COUNT,
  NSPLATE_INFO_BAR48_DEFAULT_COLUMNS,
  ...
  type NSPlateInfoBar48Bounds,
  type NSPlateInfoBar48RenderDefinition,
  type NSPlateInfoBar48RenderLayer,
  type NSPlateInfoFixedRenderDefinition,
  type NSPlateInfoFixedRenderLayer,
  type NSPlateInfoGraphicRenderDefinition,
  type NSPlateInfoGraphicRenderLayer,
  type NSPlateInfoGraphicSource,
  type NSPlateInfoIconRenderDefinition,
  type NSPlateInfoIconRenderLayer,
  type NSPlateInfoLayerPoint,
  type NSPlateInfoRenderSide,
  type NSPlateInfoSpecialRenderDefinition,
  type NSPlateInfoSpecialRenderLayer,
  type NSPlateInfoTextAlign,
  type NSPlateInfoTextRenderDefinition,
...
function createInfoFixedGraphicSource(path: string): NSPlateInfoGraphicSource | null {
  const normalizedPath = normalizeNSPlateUiAssetPath(path)
  ...
  return {
    ...
    url: resolveNSPlateImageUrl(normalizedPath)
  }
}
